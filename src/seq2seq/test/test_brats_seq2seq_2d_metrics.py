            ...
            for batch in test_loader:
                ...
                for tgt in tgt_flags:
                    ...
                    for src in flags:
                        ...
                        sitk.WriteImage(sitk.GetImageFromArray(preimg), os.path.join(dir_pred, '{}_tgt_{}.nii.gz'.format(name, tgt)))
                        sitk.WriteImage(sitk.GetImageFromArray(tgtimg), os.path.join(dir_pred, '{}_pred_{}_{}.nii.gz'.format(name, src, tgt)))
