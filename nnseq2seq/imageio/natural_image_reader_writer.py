...
if __name__ == '__main__':
    images = ('/media/fabian/data/nnSeq2Seq_raw/Dataset120_RoadSegmentation/imagesTr/img-11_0000.png',)
    segmentation = '/media/fabian/data/nnSeq2Seq_raw/Dataset120_RoadSegmentation/labelsTr/img-11.png'
