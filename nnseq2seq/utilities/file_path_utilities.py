...
from nnseq2seq.paths import nnSeq2Seq_results
...
def get_output_folder(dataset_name_or_id: Union[str, int], trainer_name: str = 'nnseq2seqTrainer',
                      plans_identifier: str = 'nnseq2seqPlans', configuration: str = '3d_fullres',
                      fold: Union[str, int] = None) -> str:
    tmp = join(nnSeq2Seq_results, maybe_convert_to_dataset_name(dataset_name_or_id),
...
if __name__ == '__main__':
    ...
    path = '/home/fabian/results/nnseq2seq_remake/Dataset002_Heart/nnseq2seqModule__nnseq2seqPlans__3d_fullres'
    print(parse_dataset_trainer_plans_configuration_from_path(path))
    path = 'Dataset002_Heart/nnseq2seqModule__nnseq2seqPlans__3d_fullres'
    print(parse_dataset_trainer_plans_configuration_from_path(path))
    path = '/home/fabian/results/nnseq2seq_remake/Dataset002_Heart/nnseq2seqModule__nnseq2seqPlans__3d_fullres/fold_all'
    print(parse_dataset_trainer_plans_configuration_from_path(path))
    try:
        path = '/home/fabian/results/nnseq2seq_remake/Dataset002_Heart/'
        print(parse_dataset_trainer_plans_configuration_from_path(path))
