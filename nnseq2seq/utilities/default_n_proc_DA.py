...
def get_allowed_n_proc_DA():
    ...
    IMPORTANT: if the environment variable nnSeq2Seq_n_proc_DA is set it will overwrite anything in this script
    (see first line).
    ...
    if 'nnSeq2Seq_n_proc_DA' in os.environ.keys():
        use_this = int(os.environ['nnSeq2Seq_n_proc_DA'])
    else:
