...
# the Evaluator class of the previous nnSeq2Seq was great and all but man was it overengineered. Keep it simple
...
def evaluate_folder_entry_point():
    ...
    parser.add_argument('-np', type=int, required=False, default=8,
                        help=f'number of processes used. Optional. Default: {8}')
...
if __name__ == '__main__':
    folder_ref = '/media/fabian/data/nnSeq2Seq_raw/Dataset004_Hippocampus/labelsTr'
    folder_pred = '/home/fabian/results/nnSeq2Seq_remake/Dataset004_Hippocampus/nnSeq2SeqModule__nnSeq2SeqPlans__3d_fullres/fold_0/validation'
    output_file = '/home/fabian/results/nnSeq2Seq_remake/Dataset004_Hippocampus/nnSeq2SeqModule__nnSeq2SeqPlans__3d_fullres/fold_0/validation/summary.json'
