...
class nnSeq2SeqDataLoader2D(nnSeq2SeqDataLoaderBase):
...
if __name__ == '__main__':
    folder = '/media/fabian/data/nnSeq2Seq_preprocessed/Dataset004_Hippocampus/2d'
    ds = nnSeq2SeqDataset(folder, None, 1000)  # this should not load the properties!
    dl = nnSeq2SeqDataLoader2D(ds, 366, (65, 65), (56, 40), 0.33, None, None)
    a = next(dl)