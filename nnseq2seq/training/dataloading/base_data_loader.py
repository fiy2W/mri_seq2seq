...
class nnSeq2SeqDataLoaderBase(DataLoader):
    def __init__(self,
                 data: nnSeq2SeqDataset,
                 batch_size: int,
        ...
        assert isinstance(data, nnSeq2SeqDataset), 'nnSeq2SeqDataLoaderBase only supports dictionaries as data'
