import torch
from nnseq2seq.training.loss.dice import SoftDiceLoss, MemoryEfficientSoftDiceLoss
from nnseq2seq.training.loss.robust_ce_loss import RobustCrossEntropyLoss, TopKLoss
from nnseq2seq.training.loss.ssim import SSIMLoss
from nnseq2seq.training.loss.perceptual import AdaptivePerceptualLoss
from nnseq2seq.utilities.helpers import softmax_helper_dim1
from torch import nn


class L1_SSIM_and_Perceptual_loss(nn.Module):
    def __init__(self, device, weight_l1=1, weight_ssim=1, weight_perceptual=1, spatial_dims=2):
        """
        ...
        :param weight_dice:
        """
        super(L1_SSIM_and_Perceptual_loss, self).__init__()
        ...
        self.l1 = nn.L1Loss()
        self.ssim = SSIMLoss(spatial_dims=spatial_dims)
        self.perceptual = AdaptivePerceptualLoss().to(device=device)

    def forward(self, deep: int, net_output: torch.Tensor, target: torch.Tensor, mask: torch.Tensor):
        """
